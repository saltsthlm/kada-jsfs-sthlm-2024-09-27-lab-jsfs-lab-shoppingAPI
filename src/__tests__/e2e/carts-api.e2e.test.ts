...
describe('The Carts API', () => {
  ...
  test('add many items', async () => {
    ...
    const product3 : Product = {
      id: product1.id, quantity: 1, item: product1.item, price: product1.price,
    };
    ...
    const expPrice = product1.quantity * product1.price + product3.quantity * product3.price;
  ...
  test('add item and validate price', async () => {
    ...
    const productWithStrangePrice : Product = {
      id: '2f81a686-7531-11e8-86e5-f0d5bf731f68', item: 'Keychain Phone Charger', quantity: 3, price: -10.2,
    };
  ...
  test('add item and validate quantity', async () => {
    ...
    const productWithStrangeQuantity = {
      id: '2f81a686-7531-11e8-86e5-f0d5bf731f68', item: 'Keychain Phone Charger', quantity: -132, price: 10.5,
    };
